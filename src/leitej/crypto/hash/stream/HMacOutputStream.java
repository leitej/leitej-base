 ...
 * @author Julio Leite
 */
public class HMacOutputStream extends AbstractHashOutputStream {
	 ...
	 * @param hmacAlgorithm
	 * @param key
	 * @param stepLength    auto verify digest at <code>stepLength</code> length of
	 *                      data
	 ...
	 */
	public HMacOutputStream(final OutputStream os, final HMacEnum hmacAlgorithm, final Key key, final int stepLength)
