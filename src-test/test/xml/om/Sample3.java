...
public interface Sample3 extends XmlObjectModelling {
	...
	public Sample3 getFilho();

	public void setFilho(Sample3 filho);

	public String[] getAo();

	public void setAo(String[] ao);

	public Set<Sample3> getSo();

	public void setSo(Set<Sample3> so);

	public Map<String, Sample3> getMo();

	public void setMo(Map<Object, Sample3> mo);

	public List<Sample3> getLo();

	public void setLo(List<Sample3> lo);

	public Sample3[] getAm();

	public void setAm(Sample3[] am);
